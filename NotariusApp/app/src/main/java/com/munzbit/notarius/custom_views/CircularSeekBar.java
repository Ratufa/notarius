...
public class CircularSeekBar extends View {
	...
	protected void initAttributes(TypedArray attrArray) {
		...
		mPointerColor = attrArray.getColor(R.styleable.CircularSeekBar_circle_pointer_color, DEFAULT_POINTER_COLOR);
		mPointerHaloColor = attrArray.getColor(R.styleable.CircularSeekBar_circle_pointer_halo_color, DEFAULT_POINTER_HALO_COLOR);
		...
		mMax = attrArray.getInt(R.styleable.CircularSeekBar_max_circle, DEFAULT_MAX);
		...
		mStartAngle = ((360f + (attrArray.getFloat((R.styleable.CircularSeekBar_circle_start_angle), DEFAULT_START_ANGLE) % 360f)) % 360f);
		mEndAngle = ((360f + (attrArray.getFloat((R.styleable.CircularSeekBar_circle_end_angle), DEFAULT_END_ANGLE) % 360f)) % 360f);
