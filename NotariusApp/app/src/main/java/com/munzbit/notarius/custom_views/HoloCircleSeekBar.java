...
public class HoloCircleSeekBar extends View {
	...
	private void initAttributes(TypedArray a) {
		...
		max = a.getInteger(R.styleable.HoloCircleSeekBar_max_holo, MAX_POINT_DEF_VALUE);
		...
		String pointer_color_attr = a
				.getString(R.styleable.HoloCircleSeekBar_holo_pointer_color);
		String pointer_halo_color_attr = a
				.getString(R.styleable.HoloCircleSeekBar_holo_pointer_halo_color);
